#' ba_studies
#'
#' Lists studies summaries available on a brapi server
#'
#' @param con list, brapi connection object
#' @param programDbId character; program filter to only return studies associated
#'                    with given program database identifier; default: ""
#' @param trialsDbId character; program filter to only return studies associated
#'                    with given program database identifier; default: ""
#' @param locationDbId character, location filter to only return studies associated
...
ba_studies <- function(con = NULL,
  ...
  brp <- get_brapi(con) %>% paste0("studies")
